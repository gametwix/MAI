...
void Shader::LoadShader(std::string VertexShaderFileName, std::string FragmentShaderFileName){
    ...
    char* vertexShaderSource = new char[VertexShaderText.size()];
    memcpy(vertexShaderSource,VertexShaderText.data(),VertexShaderText.size()*sizeof(char));
    ...
    char* fragmentShaderSource = new char[FragmentShaderText.size()];
    memcpy(fragmentShaderSource,FragmentShaderText.data(),FragmentShaderText.size()*sizeof(char));

...
int main()
{
    ...
    Slider slide8(window,Gui_shader,{WIDTH-230,HEIGHT-330},WIDTH,HEIGHT,200,30);
    Slider slide9(window,Gui_shader,{WIDTH-230,HEIGHT-370},WIDTH,HEIGHT,200,30);
...
/*         sh.SetThisShader();
        ...
        strenght = slide8.CheckRes();
        size = slide9.CheckRes()*100+1;

...
void Camera::GenProjectionMatrix(){
    ...
    //ProjectionMatrix =glm::ortho(-1.0f,1.0f, -1.0f, 1.0f, 0.01f, 10.0f );
}
...
void Camera::DrawObj(Object &obj, Shader &shader, glm::vec4 light, float lightpow,float time,float streght, float size){
    ...
    GLuint StrengthLoc = glGetUniformLocation(shaderProgram, "Strength");
    glUniform1f(StrengthLoc, streght);
    GLuint SizeLoc = glGetUniformLocation(shaderProgram, "Size");
